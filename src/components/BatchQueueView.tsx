      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">
            Audit trail of client-side file transformations and generated artifacts in this session.
          </p>
        </div>
        ...
        {jobs.length > 0 && (
          <button
            type="button"
            onClick={onClearJobs}
            className="px-3 py-1.5 rounded-lg border border-slate-300 hover:bg-slate-100 text-slate-700 text-xs font-semibold flex items-center space-x-1.5 transition-colors"
          >
